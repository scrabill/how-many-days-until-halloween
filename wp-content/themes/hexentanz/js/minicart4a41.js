...
(function () {
	...
	var config = {
		 ...
		 */
		assetURL: 'http://demo.virtuti.info/demonstrations/vt1/wp-content/themes/imaginarium/',
	...
	PAYPAL.apps.MiniCart = (function () {
		...
		var _addCSS = function () {
			...
			css.push('#' + name + ' form { position:fixed; z-index:300; float:none; top:-200px; ' + config.displayEdge + ':' + config.edgeDistance + '; width:280px; padding:50px 20px 0 20px; min-height:260px; background:#fff url(' + config.assetURL + 'images/paypal.png) no-repeat 20px 20px; background-size: 100px auto; border:none; border-top:0; font:0.8em/normal; color:#555; text-align:left;} ');
			css.push('#' + name + ' ul { position:relative; overflow-x:hidden; overflow-y:auto; height: auto; min-height: 200px; max-height: 500px; background:#fff; margin:20px 0 0 0 ; list-style-type:none; } ');
			css.push('#' + name + ' li { position:relative; margin:0; padding:0 0 6px 0; } ');
			css.push('#' + name + ' li a { display: block; width: 160px; color:#333; text-decoration:none; white-space:nowrap; overflow:hidden; text-overflow:ellipsis; line-height:normal;} ');
			css.push('#' + name + ' li a span { color:#999; font-size:12px; } ');
			css.push('#' + name + ' li .quantity { position:absolute; top:.5em; right:90px; width:24px; height:20px; padding:1px 3px 1px 1px; border:1px solid #83a8cc; text-align:right; border-radius:0; -webkit-appearance:none;} ');
			css.push('#' + name + ' li .price { position:absolute; top:.0; right:0; } ');
			css.push('#' + name + ' li .remove { position:absolute; top:9px; right:68px; width:14px; height:14px; padding:2px; background:url('+ config.assetURL + 'images/close.png) no-repeat 1px 1px; background-size:10px auto; border:1px solid #ddd; cursor:pointer; outline:none;} ');
			css.push('#' + name + ' p { margin:30px 0 0 0; line-height:normal; padding:28px 0 0 0; border-top:1px solid rgba(0,0,0,0.08);} ');
			css.push('#' + name + ' p:hover { cursor:pointer; } ');
			css.push('#' + name + ' p input { float:right; margin:0px 0 10px 0; padding:6px 10px; text-decoration:none; line-height:normal; color:#fff; background:#569FB1; border:none; border-bottom:4px solid #568C99; text-transform:uppercase; cursor:pointer; border-radius:0; -webkit-appearance:none;} ');
			css.push('#' + name + ' p .shipping {float:left; display:block; padding: 0 0 20px 0; font-size:12px; color:#999;} ');
			css.push('#' + name + ' p .shipping .symbol{float:left; display:block; padding: 7px 4px 0 0; font-size:14px; color:#999;} ');
		...
		var _buildDOM = function () {
			...
			UI.shipping.innerHTML = config.strings.shipping || 'does not include shipping &amp; tax <br/> <span class="symbol plussymbol">+</span> <span class="symbol minussymbol">-</span>';
